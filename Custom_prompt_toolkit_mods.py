...
def multi_input_dialog2(title='', ok_text='OK', cancel_text='Cancel',
                 completer=None, password=False, style=None, async_=False):
    """
    Display a text input box.
    Return the given text, or None when cancelled.
    ...
    for textField in textFieldsList:
        # # Create list of Label objects
        # labels.append(Label(text=textField[0], dont_extend_height=True))
