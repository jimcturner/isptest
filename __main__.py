                ...
                try:
                    ...
                    if len(data) > 11:
                        ...
                        try:
                            ...
                            RTP_HEADER_SIZE = 12
                            # This is the size of my own header prefix values (3 bytes: a short followed by a byte)

                            ISPTEST_HEADER_SIZE = 3
                            ...
                            if payloadSize > 0:
                                try:
                                    ...
                                    # Message.addMessage("Decode header: " + str(isptestHeaderIDField) + ", " + str(isptestHeaderFriendlyNameLength))
